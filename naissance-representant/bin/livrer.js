...
import { livrerBrief, FENETRE_TEXTE_TAPE_MS } from '../src/livraison.js';
...
// ⚠️ LE TEMPS LAISSÉ À UN TEXTE **TAPÉ** POUR BOUGER — dix secondes (T-20260818-0076).
//
...
// demande moins de quinze. Une constante par appelant, ce sont deux comportements dont un seul
// est annoncé — d'où une seule, lue dans `delivrance.js` auprès du geste qu'elle règle.
//
...
const IMMOBILITE_MS = Number(process.env.LIVRAISON_IMMOBILITE_MS || FENETRE_TEXTE_TAPE_MS);
