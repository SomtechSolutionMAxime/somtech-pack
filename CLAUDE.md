...
| `.claude/skills/` | Skills Claude Code : audit-preprod, audit-rls, audit-securite, create-migration, deploy-aims, deploy-metering, end-session, episodique, feature-doc-generator, git-module, lier-app, mcp-builder, memoire, merge, mockmig, orchestrer-chantier, plan-servicedesk, pousse-staging, prototype, rappel, scaffold-aims, scaffold-component, setup-archi-ci, somtech-pack-global, somtech-pack-maj, speckit, superplan, sync-app-state, validate-ui, webapp-testing |
