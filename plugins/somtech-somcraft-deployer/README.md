...
Ce plugin déploie la **dernière version** de SomCraft (`plugin.json` → `somcraftVersion: "latest"`, résolue au dernier tag `vX.Y.Z` au moment du déploiement ; ≥ v0.21 à ce jour).
