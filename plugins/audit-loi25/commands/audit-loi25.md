...
allowed-tools: Read, Grep, Glob, Bash(find:*, wc:*, ls:*)
---
...
### Étape 8 — Gouvernance (art. 3.1, 3.2, 3.3, 3.5-3.8, 14)
...
2. Calculer le score de conformité :
   - Démarrer à 100
...
4. Générer le plan d'action avec les corrections priorisées
5. Sauvegarder le rapport dans le dossier du projet sous `audit-loi25-rapport-YYYY-MM-DD.md`

## Format de sortie

Générer un fichier Markdown `audit-loi25-rapport-YYYY-MM-DD.md` dans le dossier racine du projet. Afficher un résumé dans le chat avec le score et les constats critiques.
