...
Tout worktree sans agent vivant dedans est un orphelin **à signaler** au CTO par ta ligne, une seule fois, puis si son état change, en finissant par `J'ai besoin de toi : retirer ou garder <chemin>` ; l'espace RESTE tant qu'il n'a pas tranché, et on ne le retire jamais faute de réponse.
