...
- **Ne l'archive pas à la main non plus, et c'est sans retour** : un canal archivé est en lecture seule, et le désarchiver n'est pas à la portée de la ligne — Slack le réserve à un compte humain. La commande refuse alors d'ouvrir en te disant quoi faire ; il faut passer par Slack.
