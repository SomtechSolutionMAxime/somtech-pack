# Serveurs MCP — (déprécié)

Ce fichier était spécifique à un projet (Orbit) et n’est plus maintenu dans le `somtech-pack`.

Utilisez le template générique à la place :

- `references/SERVEURS_MCP.md`

Si vous avez besoin d’une liste de serveurs pour votre projet, copiez `SERVEURS_MCP.md` et adaptez les URLs/outils.

### Contacts

- **Edge Function** : `contacts-mcp`
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/contacts-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/contacts-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/entreprises-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/entreprises-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/opportunites-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/opportunites-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/projets-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/projets-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/taches-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/taches-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/applications-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/applications-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/interactions-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/interactions-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/publications-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/publications-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/tickets-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/tickets-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/livrables-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/livrables-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/commande-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/commande-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/clients-mcp/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/clients-mcp/sse`
...
- **URL MCP** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/docs-reader/mcp`
- **URL Agent Builder** : `https://kedosjwbfzpfqchvgpny.supabase.co/functions/v1/docs-reader/sse`
